...
# In-memory store for restocking orders submitted during this server session.
# Not persisted; resets on restart (consistent with the rest of the mock data model).
